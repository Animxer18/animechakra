  ...
  if (animeQuery !== "popular") {
    try {
      const searchData = await fetch(
        ...
        `https://animxer-api-phi.vercel.app/meta/anilist/advanced-search?query=${animeQuery}&sort="POPULARITY_DESC"`
      );
    ...
    try {
      const searchData = await fetch(
        ...
        `https://animxer-api-phi.vercel.app/meta/anilist/advanced-search?sort="POPULARITY_DESC"`
      );
