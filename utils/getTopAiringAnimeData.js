export const getAnimeTrailers = async (randomNumber) => {
  ...
  try {
    const response = await fetch(
      "https://animexer-api.vercel.app/meta/anilist/trending",
    ...
    if (response.ok) {
      ...
      try {
        const trailerDataResp = await fetch(
          "https://animexer-api.vercel.app/meta/anilist/info/" + query,
...
export const getRecentAnime = async () => {
  try {
    const recentAnimeData = await fetch(
      ...
      "https://animexer-api.vercel.app/meta/anilist/recent-episodes?provider=gogoanime",
